var SwapperEnums =  {
  ...
  SCALE_ORIGINAL_HEIGHT:'SCALE_ORIGINAL_HEIGHT',               
  SCALE_ORIGINAL_WIDTH:'SCALE_ORIGINAL_WIDTH'                  
...
function imageSwapper () {
  ...
  var params = {
    template:'1WJDAkzgWjGHQn59DP2VlO1WI5nOqXLOApzoiLXWYccg',   // this is the document that contains the image swapping template
    scaling:SwapperEnums.SCALE_ORIGINAL_HEIGHT,                                                       
  ...
  // as below
  params.documents = [
      '1Nc3UmkzbiVQGKH0SIbswozdI0Lrw7SPo7ZFGiLZFvYA'          // this is a document to apply image swapping to
  ];
  
  
  // OR another way to populate the documents needed, instead of populating the list manually
...
//  .setService(DriveApp)
//  .getPileOfFiles (
//     FOLDER_NAME, "application/vnd.google-apps.document", true
//   );
